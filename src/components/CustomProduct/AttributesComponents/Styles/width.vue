...
<template>
   <div class="width_Attribute row align-items-center">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <div class="input-group d-flex align-items-stretch">
            ...
            <input
            class="form-control mainwidthInput"
        ...
        <p v-if="correctValue==false" class="measurement-error-width" style="color: red;">Should be greater than 
      {{attribute.min}}
       and less than 
      {{attribute.max}}
      </p>
