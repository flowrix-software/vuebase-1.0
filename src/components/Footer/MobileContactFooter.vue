...
<template>
  <div class="contact-footer text-center">
    ...
    <ul class="info-items list-unstyled">
      <li class="phone info-item justify-content-center">
        <span class="icon icon-phone"></span>
        <a class="text-center" :href="`tel:${profile.phone || defaultPhone}`">
          {{ profile.phone || defaultPhone }}
        </a>
      </li>
      <li class="email info-item justify-content-center">
        <span class="icon icon-envelope"></span>
        <a :href="`mailto:${profile.email || defaultEmail}`">
          {{ profile.email || defaultEmail }}
        </a>
      </li>
      <li class="address info-item align-items-center flex-column">
        ...
        >
          ...
          {{ profile.suburb || defaultAddress.suburb }}, {{ profile.postcode || defaultAddress.postcode }} <br />
